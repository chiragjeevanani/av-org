...
export default function Dashboard() {
  ...
  const statCards = [
    { label: 'Pending Inquiries', value: stats?.pendingInquiries || 0, icon: Inbox, color: 'from-amber-500/20 to-amber-500/5', border: 'border-amber-500/30', text: 'text-amber-400' },
    ...
    { label: 'Client Projects', value: stats?.totalProjects || 0, icon: Briefcase, color: 'from-emerald-500/20 to-emerald-500/5', border: 'border-emerald-500/30', text: 'text-emerald-400' },
    { label: 'Gallery Images', value: stats?.totalGalleryImages || 0, icon: ImageIcon, color: 'from-purple-500/20 to-purple-500/5', border: 'border-purple-500/30', text: 'text-purple-400' },
    { label: 'YouTube Videos', value: stats?.totalYoutubeVideos || 0, icon: Video, color: 'from-red-500/20 to-red-500/5', border: 'border-red-500/30', text: 'text-red-400' },
    ...
    <div className="space-y-8">
      ...
      <div>
        ...
        <p className="text-xs text-slate-400 mt-1">
          Monitor incoming customer inquiries and content statistics across AV Group.
        </p>
      </div>
      ...
      <div className="bg-slate-950 border border-slate-800 rounded-2xl p-6 space-y-4">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-xs text-slate-400">Latest form submissions from website visitors</p>
          </div>
          <Link
            to="/inquiries"
